...
```{r}
tickets_escalatedOnly <- tickets %>%
  filter(wasEscalated == 1)

tickets_notEscalated <- tickets %>%
  filter(wasEscalated == 0)

summary(tickets_escalatedOnly)
summary(tickets_notEscalated)

# See trends in seniority, category, and priority. 
```
